...
# ===== Part 1: Architecture + Modules 1-4 =====
part1 = r'''# Enterprise RAG CS — 开发者完全指南
...
write("docs/developer/DEVELOPER_GUIDE_PART1.md", part1)

# ===== Part 2: API + Frontend + Deployment + Database + Testing =====
part2 = r'''# Enterprise RAG CS — 开发者完全指南 (Part 2)
...
write("docs/developer/DEVELOPER_GUIDE_PART2.md", part2)

# ===== Merge into single file =====
with open(os.path.join(BASE, "docs/developer/DEVELOPER_GUIDE_PART1.md"), encoding="utf-8") as f:
    p1 = f.read()
with open(os.path.join(BASE, "docs/developer/DEVELOPER_GUIDE_PART2.md"), encoding="utf-8") as f:
    p2 = f.read()

full = p1 + "\n\n" + p2
write("docs/developer/DEVELOPER_GUIDE.md", full)

# Cleanup part files
os.remove(os.path.join(BASE, "docs/developer/DEVELOPER_GUIDE_PART1.md"))
os.remove(os.path.join(BASE, "docs/developer/DEVELOPER_GUIDE_PART2.md"))

print("\nMerged into docs/developer/DEVELOPER_GUIDE.md")
